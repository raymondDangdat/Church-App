...
public class LeaderAdapter extends RecyclerView.Adapter<LeaderAdapter.LeaderViewHolder> {
    ...
    @NonNull
    @Override
    public LeaderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LeaderViewHolder leaderViewHolder, int position) {
        LeadersModel leadersModel = mArrayleaders.get(position);
        leaderViewHolder.bind(leadersModel);
