...
public class RevAdapter extends RecyclerView.Adapter<RevAdapter.RevViewHolder> {
    ...
    public RevAdapter(){
        ...
        mDatabaseReference.orderByChild("position").equalTo("Leading Reverend").addChildEventListener(mChildEventListener);
    }

    @NonNull
    @Override
    public RevViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int position) {
        Context context = parent.getContext();
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.leaders_layout, parent, false);
        return new RevViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull RevViewHolder revViewHolder, int position) {
